...
# Next import relies on being in the same directory as staircase_profile.py
from staircase_profile import rho_profile
from staircase_profile import staircase
...
bgpf_array = rho_profile(z, n_layers, layer_ratio, z_b, z_t, val_bot, val_top)
bgpf_array2 = staircase(z, n_layers, layer_ratio, z_b, z_t, val_bot, val_top)
