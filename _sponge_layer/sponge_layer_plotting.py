...
x_basis  = de.Fourier('x', nx, interval=x_interval, dealias=3/2)
...
sponge_array = sponge_profile(z, z_sb, z_t, sp_slope, max_sp)
...
if (plot_bgpf):
    ...
    ax1.plot(plot_p, plot_z, linestyle='-', color='#CD853F')
